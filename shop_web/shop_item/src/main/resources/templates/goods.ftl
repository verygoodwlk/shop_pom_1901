        ...
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <IMG height="350" src="http://192.168.227.138/${gimages[0]}" jqimg="http://192.168.227.138/${gimages[0]}" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list gimages as img>
                                <li><img src="http://192.168.227.138/${img}" style="width: 50px; height: 50px"> </li>
                            </#list>
                        </ul>
                    </div>
